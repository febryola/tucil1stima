...
typedef struct {
   ElType contents[KAPASITAS]; /* memori tempat penyimpan elemen (container) */
} ListPos;
...
/*    Pembacaan diulangi sampai didapat n yang benar yaitu 0 <= n <= KAPASITAS */
/*    Jika n tidak valid, tidak diberikan pesan kesalahan */
/* 2. Jika 0 < n <= KAPASITAS; Lakukan n kali: 
...
ListPos plusMinusTab(ListPos l1, ListPos l2, bool plus);
...
bool isAllEven(ListPos l);
/* Menghailkan true jika semua elemen l genap */

void sort(ListPos *l, bool asc);
/* I.S. l boleh kosong */
